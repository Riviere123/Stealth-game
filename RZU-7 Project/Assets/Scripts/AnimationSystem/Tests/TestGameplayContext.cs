...
public class TestGameplayContext : InputContext
{
    [SerializeField]
    ...
    public override void Menu1ButtonPress()
    {
        ...
        isDead = !isDead;
        actorAnimations.SetIsDeadStatus(isDead);

        if (!isDead)
        {
            actorMovement.CantMove = false;
        }
    }
    ...
    public override void Menu2ButtonPress()
    {
        ...
        actorAnimations.SetIsInteractingStatus(true);
    }
